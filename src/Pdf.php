...
namespace ginvoicing;

use ginvoicing\helpers\File;
use ginvoicing\helpers\Command;
...
class Pdf
{
    ...
    /**
     * @var string the fully qualified dns name of the service with port e.g localhost:3323
     */
    ...
    /**
     * @var File|null the temporary PDF file
     */
    protected File|null $_tmpPdfFile = null;

    /**
     * @var File[] list of tmp file objects. This is here to
    ...
    /**
     * @var Command|null the command instance that executes wkhtmltopdf
     */
     ...
     */
    public function addPage(string $input, array $options = array(), string|null $type = null): Pdf
    {
     ...
     * @return static the Pdf instance for method chaining
     */
    public function addCover(string $input, array $options = array(), string|null $type = null): Pdf
    {
     ...
     * @return static the Pdf instance for method chaining
     */
    public function addToc(array $options = array()): Pdf
    {
     ...
     * @return bool whether PDF was created successfully
     */
    public function send(string|null $filename = null, bool $inline = false, array $headers = array()): bool
    {
        if (!$this->_isCreated && !$this->createPdf()) {
            return false;
        }
     ...
     * @return static the Pdf instance for method chaining
     */
    public function setOptions(array $options = array()): Pdf
    {
...
//        $command->addArg($fileName, null, true);    // Always escape filename
     ...
     * type. This can either be `TYPE_HTML` or `TYPE_XML`. If `null` (default)
     * the type is auto detected from the string content.
     * @return File|string a File object if the input is a HTML
     * or XML string. The unchanged input otherwhise.
     */
    protected function ensureUrlOrFile(string|File $input, string|null $type = null): File|string
    {
     ...
     */
    protected function ensureUrlOrFileOptions(array $options = array()): array
    {
        foreach ($options as $key => $val) {
